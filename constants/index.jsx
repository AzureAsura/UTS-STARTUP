export const features = [
  {
    ...
    caption: "R-Check Certified",
    title: "Verified beyond doubt",
    text: "Every vehicle passes a standardized R-Check inspection conducted by trusted partners. From engine performance to structural integrity, all data is verified — no hidden defects, no guesswork.",
    button: {
      icon: "/images/magictouch.svg",
      title: "Explore verification",
      href: '#how-it-works'
    },
  },
  {
    ...
    caption: "Digital Vehicle Identity",
    title: "One scan, total transparency",
    text: "Each certified vehicle is assigned a unique R-Check QR identity. Instantly access inspection reports, ownership records, and legal status secured with blockchain and impossible to manipulate.",
    button: {
...
export const details = [
  {
    ...
    title: "Standardized vehicle inspection",
  },
  {
    id: "1",
...
export const products = [
  {
    ...
    tag: "Most Popular",
    image: "/product1.png",
    caption: "R-CHECK CARD",
    title: "Verified Vehicle Card",
    text: "Kartu fisik premium berukuran standar dompet yang tertempel langsung pada kendaraan. Dilengkapi QR code unik yang dapat dipindai untuk mengakses seluruh data inspeksi secara real-time.",
    specs: [
      { label: "Material", value: "PVC Premium" },
      { label: "Ukuran", value: "85.6 × 54 mm" },
      { label: "Ketahanan", value: "Waterproof & UV-resistant" },
      { label: "Teknologi", value: "QR Code + NFC Ready" },
    ],
    badge: "Dompet-friendly",
    accentColor: "#2EF2FF",
  },
  {
    id: 2,
    tag: null,
    image: "/product2.png",
    caption: "R-CHECK KEYCHAIN",
    title: "Smart Key Tag",
    text: "Gantungan kunci elegan berbahan metal yang menyertai kunci kendaraan. QR code tertanam pada permukaan glossy tahan gores, memberikan akses verifikasi di mana saja dan kapan saja.",
    specs: [
      { label: "Material", value: "Zinc Alloy Metal" },
      { label: "Ukuran", value: "40 × 25 mm" },
      { label: "Ketahanan", value: "Anti-gores, Anti-karat" },
      { label: "Teknologi", value: "QR Code Laser Engraved" },
    ],
    badge: "Stylish",
    accentColor: "#C8EA80",
  },
  {
    ...
    tag: null,
    image: "/product3.png",
    caption: "R-CHECK STICKER",
    title: "Tamper-Proof Sticker",
    text: "Stiker verifikasi berkualitas tinggi yang ditempatkan di kaca depan atau bodi kendaraan. Dirancang dengan teknologi void security sehingga tidak dapat dipindahkan tanpa merusak tag.",
    specs: [
      { label: "Material", value: "Void Security Vinyl" },
      { label: "Ukuran", value: "60 × 60 mm" },
      { label: "Ketahanan", value: "All-weather, Anti-tamper" },
      { label: "Teknologi", value: "QR Code + Hologram" },
    ],
    badge: "Anti-palsu",
    accentColor: "#C4CBF5",
  },
...
export const faq = [
  {
    id: "0",
    question: "What is R-Check and how does it work?",
    answer:
      "R-Check is a vehicle verification platform that ensures transparency in used car transactions. Vehicles are inspected by trusted workshops, then assigned a unique QR code that allows buyers to access complete and verified information instantly.",
  },
  {
    id: "1",
    question: "What information can I see when scanning the QR code?",
    answer:
      "You can view detailed inspection reports, vehicle condition, ownership history, and legal document status — all in one place, verified and easy to understand.",
  },
  {
    id: "2",
    question: "How do you ensure the data cannot be manipulated?",
    answer:
      "All vehicle data is stored using blockchain technology, making it immutable and tamper-proof. This guarantees that the information you see is authentic and trustworthy.",
  },
  {
    id: "3",
    question: "Who performs the vehicle inspection?",
    answer:
      "Inspections are carried out by R-Check’s network of trusted partner workshops that follow standardized procedures to ensure consistent and accurate results.",
  },
  {
    id: "4",
    question: "Can any car get an R-Check certification?",
    answer:
      "Yes, as long as the vehicle passes our inspection standards. Vehicles that do not meet the criteria will not receive an R-Check certification.",
  },
  {
    id: "5",
    question: "Is the QR tag secure and cannot be faked?",
    answer:
      "Each QR tag is uniquely generated and linked to blockchain-secured data, making it extremely difficult to duplicate or falsify.",
  },
  {
    id: "6",
    question: "Do I need an account to scan a vehicle?",
    answer:
      "No account is required. Simply scan the QR code using your smartphone to instantly access the vehicle’s verified information.",
  },
  {
    id: "7",
    question: "How does R-Check benefit sellers?",
    answer:
      "R-Check helps honest sellers build trust by providing verified proof of their vehicle’s condition, making it easier to attract serious buyers and close deals faster.",
  },
  {
    id: "8",
    question: "How does R-Check protect buyers?",
    answer:
      "Buyers get transparent, verified data before making a decision, reducing the risk of hidden defects, fraud, or misleading information.",
  },
  {
    id: "9",
    question: "Is R-Check available nationwide?",
    answer:
      "R-Check is expanding its network of partner workshops to cover more regions, ensuring wider accessibility and consistent verification services.",
  },
];
...
export const plans = [
  {
    id: "0",
    caption: "R-CHECK CARD",
    title: "Verified Vehicle Identity Card",
    accentColor: "#2EF2FF",
...
export const testimonials = [
  {
    ...
    comment:
      "I was hesitant to buy a used car at first, but after scanning the R-Check QR code, all the data was clearly visible. It gave me much more confidence before making a deal.",
  },
  {
    id: "1",
    name: "Budi Santoso",
    ...
    comment:
      "With R-Check, buyers trust me more. My car sold faster because its condition was already verified.",
  },
  {
    id: "2",
    name: "Kevin Wijaya",
    ...
    comment:
      "I used to worry about getting scammed, but R-Check provides full transparency. Just scan the QR code and you instantly know the real condition of the car.",
  },
  {
    id: "3",
    name: "Guinevere Beck",
    ...
    comment:
      "As a dealer, R-Check really helps build trust with customers. This could become the new standard in the used car industry.",
  },
  {
    id: "4",
    name: "Dewi Lestari",
    ...
    comment:
      "I'm not a car expert, but R-Check makes everything easy to understand. The information is complete and clear.",
  },
  {
    id: "5",
    name: "Fajar Nugraha",
    ...
    comment:
      "The QR and blockchain concept is really impressive. Vehicle data becomes transparent and impossible to manipulate.",
  },
];
export const logos = [
  {
